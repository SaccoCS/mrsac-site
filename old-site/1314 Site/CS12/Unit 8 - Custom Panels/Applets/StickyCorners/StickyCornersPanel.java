...
public class StickyCornersPanel extends JPanel
{
    ...
    public void paintComponent(Graphics g)
    {
        ...
        g2.setColor( Color.BLACK);
        g2.drawLine(x,y,0,0);
        g2.drawLine(x,y,0,this.getHeight());
        g2.drawLine(x,y,this.getWidth(),this.getHeight());
        g2.drawLine(x,y,this.getWidth(),0);
